...
public class Spectro_AudioRecordTask extends AsyncTask <Void, float[], Boolean>{
    private WeakReference<Spectro_MainActivity> mMainActivity;
    ...
    Spectro_AudioRecordTask(int audioSource,
                            int sampleRate,
                            int bufferSizeRead,
                            int samplesPerUpdate,
                            int FFTSize,
                            Spectro_MainActivity mainActivity) {
        ...
        while (mMainActivity.get().getRecordingStatus()) {
            ...
            for (int indRead = 0; indRead < numRead; indRead++) {
                ...
                if (numSamples == mSamplesPerUpdate) {
                    ...
                    Spectro_FastFourierTransform.fft(FFTBuffer);
