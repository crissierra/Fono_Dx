...
public class Spectro_FFTView extends View {
    ...
    public Spectro_FFTView(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("Activar=" + mActiveStatus , mapFreqtoPx(mMinimumFrequency), paddingPx * 0.66f, mPaintTitle);
        mPaintTitle.setTextAlign(Paint.Align.RIGHT);
        canvas.drawText("Swipe izquierdo para ajustes" , mapFreqtoPx(mMaximumFrequency), paddingPx * 0.66f, mPaintTitle);
    }
